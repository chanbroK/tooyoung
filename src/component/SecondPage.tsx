...
export default function SecondPage({changeCurDivId}) {
  return (
    <div>
      <div
      ...
      <div style={{ top: "43%", left: "20%", position: "absolute" }}>
        <a style={{ fontSize: "3vw", fontWeight: "bold" }}>FOR DESIGNERS</a>
      </div>
      ...
      <div style={{ top: "62%", left: "22%", position: "absolute" }}>
        <a style={{ fontSize: "1vw", color: "white", fontWeight: "lighter" }}>
